...
def get_config():
    ...
    config.train_hparams.batch_size = 4
    config.train_hparams.num_train_steps = 10_000
    config.train_hparams.log_every_steps = 100
    ...
    config.model_hparams.latent_size = 16
